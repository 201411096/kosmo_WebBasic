...
import mybatis.board.model.Board;
...
public class BoardRepository 
{
	...
	private SqlSessionFactory getSqlSessionFactory() {
		...
		try {
			inputStream = Resources.getResourceAsStream("mybatis-board-config.xml");
		} catch (IOException e) {
...
//			String lastChildSeq = sqlSess.selectLastSequenceNumber( maxSeqNum, minSeqNum );
			...
			String lastChildSeq = sqlSess.selectOne("BoardMapper.selectLastSequenceNumber", map);
