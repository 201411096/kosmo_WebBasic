package mvc.board_mybatis.control;
...
import mvc.board_mybatis.command.Command;
import mvc.board_mybatis.command.CommandDelete;
import mvc.board_mybatis.command.CommandException;
import mvc.board_mybatis.command.CommandInput;
import mvc.board_mybatis.command.CommandList;
import mvc.board_mybatis.command.CommandNull;
import mvc.board_mybatis.command.CommandReply;
import mvc.board_mybatis.command.CommandUpdate;
import mvc.board_mybatis.command.CommandUpdateForm;
import mvc.board_mybatis.command.CommandView;
...
public class BoardControl extends HttpServlet {
	...
	private String	jspDir = "/05_mvc_class/4_mvcBoard_mybatis/";
