...
//	price = Integer.parseInt(request.getParameter(String.valueOf(price)));
	// 2. 세션의 cart 속성을 얻어온다. 
//	glist = (ArrayList<Goods>)session.getAttribute("cart"); // 형변환시 null point error가 발생할 수 있음
	...
	Goods temp = new Goods(id, name, price);
	glist.add(temp);
