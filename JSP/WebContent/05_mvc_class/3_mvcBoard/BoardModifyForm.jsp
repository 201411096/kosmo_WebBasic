...
<head>
 ...
 <body>
	<h4> 게시판 글 수정하기 </h4><br/>
	<form name='frm' method='post' action='<%=projectName %>/BoardControl?cmd=update-page'>
	...
	<input type='button' value='목록보기' onclick="window.location='<%=projectName %>/BoardControl?cmd=list-page'">
	</form>
