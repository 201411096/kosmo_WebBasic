...
<%
	String userID = null;
	if(session.getAttribute("userID") != null){ //세션에 userID가 있다면 userID를 가져옴
		userID = (String)session.getAttribute("userID");
	}
	if(userID == null){ //로그인이 되어있지 않을 경우 index페이지로 보냄
	...
	<div class="container">
		<table class="table table-bordered table-hover" style="text-align:center; border: 1px solid #dddddd">
			<thead>
				...
				<tr>
					<th style="vertical-align: middle; min-height:150px; background-color: #fafafa; color: #000000; width: 80px;"><h5>글 내용</h5></th>
