...
%>
	...
	<div id="navbar" class="collapse navbar-collapse">
		<ul class="navbar-nav mr-auto">
			<li class="nav-item active"> <!--현재 페이지 -->
	...
	<section class="container">
		<form method="get" action="./index.jsp" class="form-inline mt-3">
			<select name="lectureDivide" class="form-control mx-1 mt-2">
				...
				<option value="기타" <%if(lectureDivide.equals("기탕")) out.println("selected"); %>>기타</option>
			</select>
			...
			<button type="submit" name="submit" class="btn btn-primary mex-1 mt-2">검색</button>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="./evaluationRegisterAction.jsp" method="post">
						<div class="form-row"> <!-- form group의 합이 12가 되도록 맞추기 -->
